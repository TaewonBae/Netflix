...
import netflix.netflix.KoreaContentsYoutubeActivity;
import netflix.netflix.R;

class RecyclerViewHolderDrama1 extends RecyclerView.ViewHolder {
    ...
    public RecyclerViewHolderDrama1(final View itemView) {
        super(itemView);
...
public class RecyclerViewAdapterDrama1 extends RecyclerView.Adapter<RecyclerViewHolderDrama1> {

    public Context context;
    public static List<Netflix_DB_list> netflixList;


    public RecyclerViewAdapterDrama1(Context context, List<Netflix_DB_list> netflixList) {
    ...
    @NonNull
    @Override
    public RecyclerViewHolderDrama1 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from((parent.getContext()));
        View itemView = inflater.inflate(R.layout.home1_recyclerview_drama, parent, false);

        return new RecyclerViewHolderDrama1(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecyclerViewHolderDrama1 holder, int position) {
        ...
        holder.Netflix_sub_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, KoreaContentsYoutubeActivity.class);
